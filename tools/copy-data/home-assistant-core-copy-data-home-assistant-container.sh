...
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/reyad010/ProxmoxVE/mainmain/tools/copy-data//home-assistant-core-copy-data-home-assistant-container.sh)"
