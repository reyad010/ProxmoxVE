...
source /dev/stdin <<<$(curl -fsSL https://raw.githubusercontent.com/reyad010/ProxmoxVE/main/misc/api.func)
...
qm set $VMID \
  ...
  -boot order=scsi0 \
  -description "<div align='center'><a href='https://Helper-Scripts.com' target='_blank' rel='noopener noreferrer'><img src='https://raw.githubusercontent.com/reyad010/ProxmoxVE/main/misc/images/logo-81x112.png'/></a>
